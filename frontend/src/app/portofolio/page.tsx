      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold text-white mb-4">
            My <span className="bg-gradient-to-r from-indigo-500 to-violet-500 bg-clip-text text-transparent">Projects</span>
          </h1>
          <p className="text-gray-400 max-w-2xl mx-auto">
            Kumpulan proyek yang telah saya kerjakan dalam web development, mobile app development, dan UI/UX design.
          </p>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
          {loading ? (
            ...
            filteredProjects.map((project) => (
              <div
                key={project.id}
                className="flex flex-col h-full rounded-2xl bg-gray-900/50 border border-gray-800 overflow-hidden hover:border-indigo-500/50 transition-all duration-300 group"
              >
                <div className="aspect-video bg-gradient-to-br from-indigo-900/20 to-violet-900/20 flex items-center justify-center border-b border-gray-800 group-hover:from-indigo-900/30 group-hover:to-violet-900/30 transition-all duration-300">
