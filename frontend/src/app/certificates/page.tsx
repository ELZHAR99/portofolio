    ...
    <div className="container mx-auto px-4 py-12">
      <div className="text-center mb-12">
        ...
        <p className="text-gray-400 max-w-2xl mx-auto">
          Sertifikasi keahlian dan pencapaian akademik yang saya raih selama menempuh pembelajaran di bidang Informatika.
        </p>
      </div>
          ...
          >
            <div>
              ...
              <div className="space-y-1.5 text-xs text-gray-400">
                <p>
                  <span className="font-medium text-gray-300">Diterbitkan:</span>{" "}
                  {cert.date}
                </p>
                <p>
                  <span className="font-medium text-gray-300">ID Kredensial:</span>{" "}
                  {cert.credentialId}
                </p>
              </div>
            </div>
            ...
            <div className="mt-6 pt-4 border-t border-gray-800">
              ...
              >
                Lihat Kredensial <span className="text-sm">↗</span>
              </a>
            </div>
          </div>
        ))}
